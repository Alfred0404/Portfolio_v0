...
<template>
  <div ref="elementRef" class="bg-slate-950 text-slate-50">
    <div
      class="group relative flex cursor-pointer flex-col items-start py-10 ps-10 text-slate-400 after:absolute after:left-[8px] after:top-20 after:z-10 after:h-4/5 after:w-0.5 after:bg-slate-900"
    ...
    >
      ...
      <ul class="flex max-w-lg flex-wrap">
        <li v-for="competence in props.competences" :key="competence">
          <Tag class="mr-2 mt-4" :tag_name="competence" />
        </li>
      </ul>
      <div
